...
function widget.new(args)
	...
	function widget_instance:_load_widget_settings()
		...
		self.font = args.font or beautiful.hotkeys_font or "Sauce Code Pro Bold 9"
		self.description_font = args.description_font or beautiful.hotkeys_description_font or "Sauce Code Pro 8"
