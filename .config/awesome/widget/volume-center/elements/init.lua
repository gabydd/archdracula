...
elements.create = function(description, sinkNumText, sinkNum, isDefault)
	...
	setDefaultSink:connect_signal("mouse::enter", function()
		setDefaultSink.bg = colors.color1
	end)

	setDefaultSink:connect_signal("mouse::leave", function()
		setDefaultSink.bg = colors.colorA
	end)

	setDefaultSink:buttons(gears.table.join(awful.button({}, 1, nil, function()
