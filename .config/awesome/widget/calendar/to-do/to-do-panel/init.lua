...
removeToDoElement = function(dateString, int, box)
	...
	awful.spawn.easy_async_with_shell(
		...
		[[cat /home/gaby/.config/awesome/widget/calendar/to-do/to-do-background/todo.json]],
		function(stdout)
			...
			awful.spawn.with_shell(
				'echo "'
					.. jsonString
					.. '" > /home/gaby/.config/awesome/widget/calendar/to-do/to-do-background/todo.json'
			)
