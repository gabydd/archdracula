...
awesome.connect_signal("bluetooth::power:toggle", function()
	if power_status == false then
		power_status = true
...
awesome.connect_signal("bluetooth::power:refresh", function()
	awful.spawn.easy_async_with_shell([[bash -c "bluetoothctl show | sed -n '5p'"]], function(stdout)
