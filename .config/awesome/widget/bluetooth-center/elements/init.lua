...
elements.create = function(name, macAddress, pairStatus, connectStatus)
	...
	pair:connect_signal("mouse::enter", function()
		pair.bg = colors.color1
	end)

	pair:connect_signal("mouse::leave", function()
	...
	unpair:connect_signal("mouse::enter", function()
		unpair.bg = colors.color1
	end)

	unpair:connect_signal("mouse::leave", function()
	...
	connect:connect_signal("mouse::enter", function()
		connect.bg = colors.color1
	end)

	connect:connect_signal("mouse::leave", function()
	...
	pair:buttons(gears.table.join(awful.button({}, 1, nil, function()
		awful.spawn.with_shell("bluetoothctl pair " .. macAddress)
	end)))

	unpair:buttons(gears.table.join(awful.button({}, 1, nil, function()
		awful.spawn.with_shell("bluetoothctl remove " .. macAddress)
	end)))

	connect:buttons(gears.table.join(awful.button({}, 1, nil, function()
		awful.spawn.with_shell("bluetoothctl connect " .. macAddress)
	end)))

	disconnect:buttons(gears.table.join(awful.button({}, 1, nil, function()
